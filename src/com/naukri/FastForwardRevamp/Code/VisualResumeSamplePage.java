...
public class VisualResumeSamplePage {
	public WebDriver driver;
	GenericFunctions generic;
	public VisualResumeSamplePage(WebDriver driver,GenericFunctions generic)
	{
		this.driver=driver;
	...
	public static final String VisualResumeSampleHeading_WE = "//h1[@class='heroLine fadeInLeft']";
	public static final String HeroLineContent_WE = "//p[@class='font_16 txtWhite fadeInLeft']";
	...
	public static final String ExperienceULid_DD = "(//div[@class='matchParent content']/ul/li)";

	public static final String Price_WE = "//p[@id='price']";
	public static final String BuyNow_lnk = "//a[@id='buyResume']";
	...
	public static final String TextResumeSample_WE = "//div[@class='font_22']";
